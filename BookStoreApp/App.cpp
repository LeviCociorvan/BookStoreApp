...
void contact(utilizator* u)
{
    ...
    try {
        ...
        case '1':
            ...
            //WinExec("curl smtps://smtp.gmail.com:465 -v --mail-from \"cociorvan2002@gmail.com\" --mail-rcpt \"receptor@gmail.com\" --ssl-reqd --user cociorvan2002@gmail.com:agrafe123 -T \"email.txt\" -k --anyauth", SW_HIDE);
            break;
        case '2':
            break;
        default:
